...
public class LearnOptions extends Options {
    ...
    public boolean domainAdaptation = false;
...
//		System.err.println("                         -reranker option (obviously)");
    ...
    boolean verifyArguments() {
        ...
        try {
            ...
            Logger.getLogger(LearnOptions.class.getName()).log(Level.SEVERE, null, ex);
        }
        return true;
    }

    public static File setupTempDir() throws InterruptedException {
        String curDateTime = new SimpleDateFormat("yyyyMMdd_HHmmssSSS").format(new Date());
